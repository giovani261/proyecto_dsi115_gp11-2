...
<div class="container py-5">
    <div class="row">
        <div class="col-md-12">
            ...
            <br>
                <a href="#" data-bs-toggle="modal" data-bs-target="#crearUsuarioModalCenter" class="btn btn-primary"><i class="fa-solid fa-user-plus"></i> Agregar Usuarios</a>
            <br>
           <br>
...
<div class="modal fade" id="crearUsuarioModalCenter" tabindex="-1"
    ...
    <div class="modal-content">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" onclick="removevalidateform('modalcrearusuario');removecheck('modalCrear');">
        </button>
        </div>
...
<div class="modal fade" id="editarUsuarioModalCenter" tabindex="-1"
    ...
    <div class="modal-content">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" onclick="removevalidateform('modaleditarusuario');removecheck('modalEditar');">
        </button>
        </div>
        <div class="modal-body">
                ...
                $.ajax({
                    ...
                    success: function(test){
                        ...
                        for(var i=0;i<=test.Usuario[0].roles.length-1;i++){
                            ...
                            if(test.Usuario[0].roles[i].name == "secretaria"){
                                $('#SecretariaCheck').prop('checked', true);
                            }
                            if(test.Usuario[0].roles[i].name == "asistente"){
